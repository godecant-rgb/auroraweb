...
export default function VariantSelector({
  ...
  return (
    <div className="rounded-[2rem] border border-[#E9DBDC] bg-white p-7 shadow-[0_16px_40px_rgba(0,0,0,0.06)]">
      <div className="space-y-7">
              ...
              <button
                ...
                className={`rounded-full border px-4 py-2 text-sm transition ${
                  selectedColor === color
                    ...
                    : "border-[#E7D8D7] bg-[#FCF9F8] text-[#555555] hover:border-[#C8949D]"
                }`}
              >
                {color}
              </button>
              ...
              <button
                ...
                className={`rounded-xl border px-4 py-2 text-sm transition ${
                  selectedSize === variant.size
                    ...
                    : "border-[#E7D8D7] bg-[#FCF9F8] text-[#555555]"
        ...
        <div className="rounded-2xl border border-[#EFE5E6] bg-[#FCF9F8] p-4 text-sm text-[#666666]">
          {selectedVariant ? (
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          <button
            ...
            className="rounded-full bg-[#1F1F1F] px-6 py-3 text-sm font-medium text-white shadow-[0_12px_28px_rgba(0,0,0,0.14)] transition hover:bg-black disabled:cursor-not-allowed disabled:opacity-50"
          >
            Agregar al carrito
          </button>
